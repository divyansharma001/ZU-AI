...
export function SidebarMenu() {
    ...
    return (
        ...
        <ScrollArea className="h-screen lg:w-48 sm:w-full bg-gray-50 border border-black">
        <div className="text-center text-3xl font-bold m-3 p-3 pt-8 w-32 h-16">ZU AI</div>
